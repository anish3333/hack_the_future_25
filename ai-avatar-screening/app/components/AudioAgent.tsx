...
export default function AudioCapture({ onTranscription }: AudioCaptureProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="relative bg-muted rounded-lg p-4 flex flex-col items-center justify-center">
